...
```Bash
$ dart pratikum.dart 
Volume Kubus adalah 3375 cm
Volume Balok adalah 6600 cm
```
...
```Bash
$ dart pratikum.dart 
Hasil dari kelipatan persekutuan terkecil 9 dan 12 adalah 36
Hasil dari faktor persekutuan terbesar 22 dan 99 adalah 11
```